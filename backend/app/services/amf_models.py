"""Modeles de donnees du pilier 6 - Conformite AMF."""
...
class ComplianceResult:
    ...
    def to_dict(self) -> dict:
        # Traçabilité du régulateur. La liste ABE Infoservice est vérifiée pour
        # l'AMF. Le résultat est "found" si une correspondance existe, sinon
        # "not_found".
